    ...
    struct SetRowView: View {
        ...
        let focusedField: FocusState<TemplateDetailView.FocusField?>.Binding
            ...
            HStack {
                ...
                TextField("Reps", text: $repsText)
                    ...
                    .onChange(of: set.completedReps) { _ in
                        if focusedField.wrappedValue != .reps(set.id) {
                            repsText = String(set.completedReps ?? set.targetReps)
                        }
                    }

                    .onChange(of: set.targetReps) { _ in
                        if set.completedReps == nil && focusedField.wrappedValue != .reps(set.id) {
